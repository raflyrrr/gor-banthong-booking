...
<head>
	...
	<title>GOR BANTHONG - Dashboard</title>
			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<div class="row">
						...
						$sql3 = mysqli_query($db_connection, "SELECT count(status) as accepted from transaksi");
						...
						<?php
						include "dbConnect.php";
						$sql = mysqli_query($db_connection, "SELECT sum(price) as total from transaksi");
